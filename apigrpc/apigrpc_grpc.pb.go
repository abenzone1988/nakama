...
const (
	...
	Nakama_AuthenticateBiliGame_FullMethodName              = "/nakama.api.Nakama/AuthenticateBiliGame"
...
type NakamaClient interface {
	...
	// Authenticate a user with BiliGame code.
	AuthenticateBiliGame(ctx context.Context, in *game.AuthenticateBiliGameRequest, opts ...grpc.CallOption) (*api.Session, error)
...
func (c *nakamaClient) AuthenticateBiliGame(ctx context.Context, in *game.AuthenticateBiliGameRequest, opts ...grpc.CallOption) (*api.Session, error) {
	out := new(api.Session)
	err := c.cc.Invoke(ctx, Nakama_AuthenticateBiliGame_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NakamaServer interface {
	...
	// Authenticate a user with BiliGame code.
	AuthenticateBiliGame(context.Context, *game.AuthenticateBiliGameRequest) (*api.Session, error)
	// Submit an invitation request.
...
func (UnimplementedNakamaServer) AuthenticateBiliGame(context.Context, *game.AuthenticateBiliGameRequest) (*api.Session, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AuthenticateBiliGame not implemented")
}
...
func _Nakama_AuthenticateBiliGame_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(game.AuthenticateBiliGameRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NakamaServer).AuthenticateBiliGame(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Nakama_AuthenticateBiliGame_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NakamaServer).AuthenticateBiliGame(ctx, req.(*game.AuthenticateBiliGameRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Nakama_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AuthenticateBiliGame",
			Handler:    _Nakama_AuthenticateBiliGame_Handler,
		},
		{
