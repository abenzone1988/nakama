...
type BattleData struct {
	...
	ChallengeAdBuyTimes    int32           `json:"challenge_ad_buy_times"`     // 当日通过广告购买的挑战次数
	ChallengeGemBuyTimes   int32           `json:"challenge_gem_buy_times"`    // 当日通过钻石购买的挑战次数
}
...
func (d *BattleData) Init() {
	...
	d.ChallengeTimes = 0
	d.LastChallengeDate = ""
	d.ChallengeAdBuyTimes = 0
	d.ChallengeGemBuyTimes = 0
	d.SetVersion("")
}
...
func (d *UserMatch) GetCollection() string {
	return "user_data"
}

func (d *UserMatch) GetKey() string {
	return "match"
}

func (d *UserMatch) Init() {
	d.Challenges = map[int32]*ChallengeStatus{}
	d.TopThreeData = &TopThreeStats{
